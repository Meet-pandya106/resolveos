...
const DashboardView = lazy(() =>
	import("./features/dashboard/DashboardView.js").then((m) => ({
		default: m.DashboardView,
	})),
);
const CaseListView = lazy(() =>
	import("./features/cases/CaseListView.js").then((m) => ({
		default: m.CaseListView,
	})),
);
const CaseDetailView = lazy(() =>
	import("./features/cases/CaseDetailView.js").then((m) => ({
		default: m.CaseDetailView,
	})),
);
const EvidenceGraphView = lazy(() =>
	import("./features/graph/EvidenceGraphView.js").then((m) => ({
		default: m.EvidenceGraphView,
	})),
);
const PrivacyCenterView = lazy(() =>
	import("./features/privacy/PrivacyCenterView.js").then((m) => ({
		default: m.PrivacyCenterView,
	})),
);
const SecurityCenterView = lazy(() =>
	import("./features/security/SecurityCenterView.js").then((m) => ({
		default: m.SecurityCenterView,
	})),
);
const LoginView = lazy(() =>
	import("./features/auth/LoginView.js").then((m) => ({
		default: m.LoginView,
	})),
);
const RegisterView = lazy(() =>
	import("./features/auth/RegisterView.js").then((m) => ({
		default: m.RegisterView,
	})),
);
const LandingView = lazy(() =>
	import("./features/landing/LandingView.js").then((m) => ({
		default: m.LandingView,
	})),
);
const SettingsView = lazy(() =>
	import("./features/settings/SettingsView.js").then((m) => ({
		default: m.SettingsView,
	})),
);
const LegalView = lazy(() =>
	import("./features/legal/LegalView.js").then((m) => ({
		default: m.LegalView,
	})),
);
			...
			<Suspense fallback={<LoadingFallback />}>
				<Routes>
					...
					<Route
						path="/login"
						element={
							!isAuthenticated ? <LoginView /> : <Navigate to="/" replace />
						}
					/>
					<Route
						path="/register"
						element={
							!isAuthenticated ? <RegisterView /> : <Navigate to="/" replace />
						}
					/>
