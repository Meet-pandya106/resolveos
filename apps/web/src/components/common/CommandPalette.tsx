...
export const CommandPalette: React.FC = () => {
	const { isCommandPaletteOpen, setCommandPaletteOpen, toggleTheme, theme } =
		useUIStore();
						...
						filtered.map((cmd, idx) => {
							...
							return (
								...
								>
									...
									<span
										className={`text-[10px] font-mono uppercase tracking-wider ${isSelected ? "text-primary-foreground/70" : "text-muted-foreground"}`}
									>
										Action
									</span>
								</button>
